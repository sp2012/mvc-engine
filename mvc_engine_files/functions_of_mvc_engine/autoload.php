...
function __autoload($class_name)
{
    ...
    require_once "../../../mvc_engine_files/classes_of_mvc_engine/classes_of_mvc_engine_it_self/JSON.php";
    ...
    $array_paths_of_classes_of_mvc_engine = $json_paths_classes_of_mvc_engine_object->jsonDecodeToArray
        ("../../../mvc_engine_files/configuration_files_of_mvc_engine/classes_autoload_paths_of_mvc_engine.json");
    ...
    $array_paths_of_classes_of_the_user = $json_paths_user_classes_object->jsonDecodeToArray
        (".././user_configuration_files/user_classes_autoload_paths.json");
